...
def load_command_class(app_name, name):
    ...
    """
    # 例如django.contrib.staticfiles.management.commands.runserver
    # contrib: django标准库
...
class ManagementUtility:
    ...
    def fetch_command(self, subcommand):
        ...
        if isinstance(app_name, BaseCommand):
            ...
            # b 解析字符串: contrib.staticfiles
            #   对于runserver: 实际执行contrib.staticfiles.management.comamnds.runserver
